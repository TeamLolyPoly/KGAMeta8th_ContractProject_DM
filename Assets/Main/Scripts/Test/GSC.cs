...
namespace Projec_DM
{
    ...
    public class Optimization
    {
        ...
        [Tooltip(
            "Works only in PlayMode. Avoids GameObject overload by offloading all meshes directly to the GPU."
        )]
                    ...
                    if (!optimization.GPUInstancedMeshes)
                    {
                        ...
                        switch (construction)
                        {
                            case Construction.SteelIBeam:
                                for (int i = 0; i < columns; i++)
                                {
                                    for (int j = 0; j < rows + 1; j++)
                                    {
                                        ...
                                        if (j == rows)
                                        {
                                            beamGO = GameObject.Instantiate(
                                                geometry.beam,
                                                new Vector3(i, 0, j),
                                                Quaternion.identity,
                                                transform
                                            );
                                            beamGO.transform.localScale = new Vector3(
                                                1,
                                                height * j + 0.2f,
                                                1
                                            );
                            ...
                            case Construction.Court:
                                ...
                                {
                                    beamSetGO = GameObject.Instantiate(
                                        geometry.beamSet,
                                        new Vector3(i, 0.1f, 0),
                                        Quaternion.identity,
                                        transform
                                    );
                        ...
                        switch (construction)
                        {
                            case Construction.SteelIBeam:
                                for (int i = 0; i < rows; i++)
                                {
                                    if (columns % 2 == 0)
                                    {
                                        plankGO = GameObject.Instantiate(
                                            geometry.plank,
                                            new Vector3(
                                                columns / 2 - 0.5f,
                                                height * (0.5f + (float)i / (float)2),
                                                i - 0.05f
                                            ),
                                            Quaternion.identity,
                                            transform
                                        );
                                        plankGO.transform.localScale = new Vector3(
                                            0.1f + (columns - 1),
                                            0.5f,
                                            1
                                        );
                        ...
                        if (geometry.step != null)
                            for (int i = 0; i < rows; i++)
                            {
                                stepGO = GameObject.Instantiate(
                                    geometry.step,
                                    new Vector3(
                                        0.55f,
                                        height * (0.6f + (float)i / (float)2),
                                        i + 0.45f
                                    ),
                                    Quaternion.identity,
                                    transform
                        ...
                        switch (distribution)
                        {
                            case Distribution.Standard:
                                for (int i = 0; i < columns - 3; i++)
                                {
                                    ...
                                    {
                                        seatingCapacity++;
                                        seatGO = GameObject.Instantiate(
                                            geometry.seat,
                                            new Vector3(
                                                i + 1.5f,
                                                height * (0.6f + (float)j / (float)2),
                                                j
                                            ),
                                            Quaternion.identity,
                                            transform
                                        ...
                                        {
                                            spectatorGO = GameObject.Instantiate(
                                                geometry.spectator[
                                                    seatingCapacity % geometry.spectator.Count
                                                ],
                                                new Vector3(
                                                    i + 1.5f,
                                                    height * ((float)j / (float)2) - 0.2f,
                                                    j + 0.3f
                                                ),
                        ...
                        for (int i = 0; i < rows; i++)
                        {
                            railGO = GameObject.Instantiate(
                                geometry.rail,
                                new Vector3(0, height * (0.6f + (float)i / (float)2), i + 0.45f),
                                Quaternion.identity,
                                transform
                            );
                            railGO = GameObject.Instantiate(
                        ...
                        for (int i = 0; i < columns - 1; i++)
                        {
                            railGO = GameObject.Instantiate(
                                ...
                                new Vector3(
                                    i + 0.5f,
                                    height * (0.6f + (float)(rows - 1) / (float)2),
                                    rows
                                ),
                        ...
                        if (optimization.GPUInstancedMaterials)
                        {
                            ...
                            geometry
                                .plank.GetComponent<MeshRenderer>()
                                .sharedMaterial.enableInstancing = true;
                            geometry
                                .rail.GetComponent<MeshRenderer>()
                                .sharedMaterial.enableInstancing = true;
                            geometry
                                .seat.GetComponent<MeshRenderer>()
                                .sharedMaterial.enableInstancing = true;
                        }
                        else
                        {
                            geometry
                                .beam.GetComponent<MeshRenderer>()
                                .sharedMaterial.enableInstancing = false;
                            geometry
                                .plank.GetComponent<MeshRenderer>()
                                .sharedMaterial.enableInstancing = false;
                            geometry
            ...
            if (optimization.GPUInstancedMeshes)
            {
                ...
                for (int i = 0; i < distinct.Count; i++)
                {
                    ...
                    while (flag)
                    {
                        ...
                        {
                            geometryMeshes[i] = transform
                                .GetChild(index)
                                .gameObject.GetComponent<MeshFilter>()
                                .sharedMesh;
                            geometryMaterial[i] = transform
                                .GetChild(index)
                ...
                for (int j = 0; j < transform.childCount; j++)
                {
                    ...
                    {
                        geometryMatrices[i][geometryCounts[i]] = Matrix4x4.TRS(
                            transform.GetChild(j).transform.position,
                            transform.GetChild(j).transform.rotation,
                            transform.GetChild(j).transform.localScale
                        );
                        geometryCounts[i]++;
                    }
                }
                ...
                for (int i = 0; i < geometry.spectator.Count; i++)
                {
                    ...
                    for (int j = 0; j < transform.childCount; j++)
                    {
                        ...
                        {
                            spectatorMatrices[i][spectatorCount[i]] = Matrix4x4.TRS(
                                transform.GetChild(j).transform.position,
                                transform.GetChild(j).transform.rotation,
                                transform.GetChild(j).transform.localScale
                            );
