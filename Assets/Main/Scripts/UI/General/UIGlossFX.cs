...
public class UIGlossFX : BaseMeshEffect
#if UNITY_EDITOR
...
#endif
{
    ...
    //################################
    public const string shaderName = "UI/UI_Gloss_FX";
    ...
    protected override void Start()
    {
        if (m_IsLoop)
        {
            StartCoroutine(PlayLoop(m_Duration));
        }
    }
    ...
    public IEnumerator PlayLoop(float duration)
    {
        while (true)
        {
