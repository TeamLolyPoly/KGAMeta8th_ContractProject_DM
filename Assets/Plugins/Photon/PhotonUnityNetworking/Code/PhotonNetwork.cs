...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        public static string GameVersion
        {
            ...
            {
                gameVersion = value;
                NetworkingClient.AppVersion = string.Format(
                    "{0}_{1}",
                    value,
        ...
        public static string ServerAddress
        {
            get
            {
                return (NetworkingClient != null)
                    ? NetworkingClient.CurrentServerAddress
                    : "<not connected>";
            }
        }
        ...
        public static Player[] PlayerListOthers
        {
            get
            {
                ...
                if (room != null)
                {
                    // TODO: implement more effectively. maybe cache?!
                    return room
                        .Players.Values.OrderBy((x) => x.ActorNumber)
                        .Where(x => !x.IsLocal)
                        .ToArray();
                }
                return new Player[0];
        ...
        public static float KeepAliveInBackground
        {
            set
            {
                if (PhotonHandler.Instance != null)
                {
                    PhotonHandler.Instance.KeepAliveInBackground = (int)
                        Mathf.Round(value * 1000.0f);
                }
            }
            get
            {
        ...
        public static bool IsMasterClient
        {
            get
            {
                ...
                return NetworkingClient.CurrentRoom != null
                    && NetworkingClient.CurrentRoom.MasterClientId == LocalPlayer.ActorNumber; // TODO: implement MasterClient shortcut in LBC?
            }
        }
        ...
        public static Player MasterClient
        {
            get
            {
                ...
                return NetworkingClient.CurrentRoom.GetPlayer(
        ...
        public static bool CrcCheckEnabled
        {
            ...
            set
            {
                ...
                {
                    Debug.Log(
                        "Can't change CrcCheckEnabled while being connected. CrcCheckEnabled stays "
        ...
        public static PhotonPortDefinition ServerPortOverrides
        {
            ...
            {
                return (NetworkingClient == null)
                    ? new PhotonPortDefinition()
                    : NetworkingClient.ServerPortOverrides;
            }
            set
            {
                if (NetworkingClient != null)
        ...
        private static void StaticReset()
        {
            ...
            rpcShortcuts = new Dictionary<string, int>(
                PhotonNetwork.PhotonServerSettings.RpcList.Count
            );
        ...
        public static bool ConnectUsingSettings()
        {
            ...
            return ConnectUsingSettings(
                ...
                PhotonServerSettings.StartInOfflineMode
            );
        }
        ...
        ) // parameter name hides static class member
        {
            ...
            {
                Debug.LogWarning(
                    "Can't connect: Application is closing. Unity called OnApplicationQuit()."
                );
                return false;
            }
            if (PhotonServerSettings == null)
        ...
        public static bool ConnectToMaster(string masterServerAddress, int port, string appID)
        {
            ...
            NetworkingClient.MasterServerAddress =
                (port == 0) ? masterServerAddress : masterServerAddress + ":" + port;
        ...
        {
            if (
                NetworkingClient.LoadBalancingPeer.PeerState != PeerStateValue.Disconnected
        ...
        public static bool Reconnect()
        {
            ...
            {
                Debug.LogWarning(
                    "Reconnect() failed. It seems the client wasn't connected before?! Current state: "
                        + NetworkingClient.LoadBalancingPeer.PeerState
                );
                return false;
            }
        ...
        public static bool CloseConnection(Player kickPlayer)
        {
            ...
            {
                TargetActors = new int[] { kickPlayer.ActorNumber },
            };
            return NetworkingClient.OpRaiseEvent(
                PunEvent.CloseConnection,
                null,
                options,
        ...
        )
        {
                ...
                Debug.LogError(
                    "JoinRandomRoom failed. Client is on "
                        ...
                        + (
                            IsConnectedAndReady
                                ? " and ready"
                                : " but not ready for operations (State: "
            ...
            typedLobby =
                typedLobby ?? ((NetworkingClient.InLobby) ? NetworkingClient.CurrentLobby : null); // use given lobby, or active lobby (if any active) or none
        ...
        public static bool RejoinRoom(string roomName)
        {
            ...
            {
                Debug.LogError(
                    "RejoinRoom failed. A roomname is required. If you don't know one, how will you join?"
                );
                return false;
            }
        ...
        public static bool ReconnectAndRejoin()
        {
            ...
            if (OfflineMode)
            {
                OfflineMode = false; // Cleanup offline mode
                Debug.LogWarning(
                    "ReconnectAndRejoin() disabled the offline mode. No longer offline."
                );
            }
        ...
        /// </summary>
        private static void EnterOfflineRoom(
            string roomName,
            RoomOptions roomOptions,
            bool createdRoom
        )
        ...
        public static void RemovePlayerCustomProperties(string[] customPropertiesToDelete)
        {
            ...
            if (
                customPropertiesToDelete == null
                || customPropertiesToDelete.Length == 0
        ...
        /// <param name="sendOptions">Send options for reliable, encryption etc..</param>
        /// <returns>False if event could not be sent</returns>
        private static bool RaiseEventInternal(
            byte eventCode,
            object eventContent,
            RaiseEventOptions raiseEventOptions,
            SendOptions sendOptions
        ...
        public static bool AllocateRoomViewID(PhotonView view)
        {
            ...
            {
                Debug.LogError(
                    "Only the Master Client can AllocateRoomViewID(). Check PhotonNetwork.IsMasterClient!"
                );
                return false;
            }
        ...
        )
        {
            ...
            Pun.InstantiateParameters netParams = new InstantiateParameters(
                prefabName,
                position,
                rotation,
                group,
        ...
        private static GameObject NetworkInstantiate(
            Pun.InstantiateParameters parameters,
            bool roomObject = false,
        ...
        )
        {
            ...
            {
                Debug.LogWarning(
                    "PrefabPool.Instantiate() should return an inactive GameObject. "
                        + prefabPool.GetType().Name
                        + " returned an active object. PrefabId: "
                        + parameters.prefabName
                );
            }
            ...
            for (int i = 0; i < photonViews.Length; i++)
            {
                if (localInstantiate)
                {
                    ...
                    parameters.viewIDs[i] =
                        (roomObject)
                            ? AllocateViewID(0)
                            : AllocateViewID(parameters.creator.ActorNumber);
                }
            ...
            if (!PrefabsWithoutMagicCallback.Contains(parameters.prefabName))
            {
                ...
                if (list.Length > 0)
                {
                    PhotonMessageInfo pmi = new PhotonMessageInfo(
                        parameters.creator,
        ...
        private static readonly RaiseEventOptions SendInstantiateRaiseEventOptions =
            new RaiseEventOptions(); // SendInstantiate reuses this to reduce GC

        internal static bool SendInstantiate(
            Pun.InstantiateParameters parameters,
            bool roomObject = false
        )
        {
            ...
            return PhotonNetwork.RaiseEventInternal(
                PunEvent.Instantiation,
                SendInstantiateEvHashtable,
        ...
        )
        {
            ...
            {
                Debug.LogWarning(
                    "RPCs can only be sent in rooms. Call of \""
                        + methodName
        ...
        )
        {
            ...
            {
                Debug.LogError(
                    "RPC can't be sent to target Player being null! Did not send \""
                        + methodName
                        + "\" call."
                );
            }
        ...
        public static void LoadLevel(int levelNumber)
        {
            ...
            _AsyncLevelLoadingOperation = SceneManager.LoadSceneAsync(
                levelNumber,
        ...
        private static void SetupLogging()
        {
            ...
            {
                PhotonNetwork.NetworkingClient.LoadBalancingPeer.DebugOut = PhotonServerSettings
                    .AppSettings
                    .NetworkLogging;
            }
        }
        ...
        public static void LoadOrCreateSettings(bool reload = false)
        {
            ...
            {
                Debug.LogWarning(
                    "photonServerSettings is not null. Will not LoadOrCreateSettings()."
                );
                return;
            }
            ...
            photonServerSettings = (ServerSettings)
                Resources.Load(PhotonNetwork.ServerSettingsFileName, typeof(ServerSettings));
            if (photonServerSettings != null)
            {
                return;
            }
            ...
            {
                photonServerSettings = (ServerSettings)
                    ScriptableObject.CreateInstance("ServerSettings");
                if (photonServerSettings == null)
                {
                    Debug.LogError(
            ...
            string serverSettingsAssetPath =
                punResourcesDirectory + PhotonNetwork.ServerSettingsFileName + ".asset";
        ...
        public static void InternalCleanPhotonMonoFromSceneIfStuck()
        {
            ...
            if (photonHandlers != null && photonHandlers.Length > 0)
            {
                ...
                foreach (PhotonHandler photonHandler in photonHandlers)
                {
                    ...
                    if (
                        photonHandler.gameObject != null
                        && photonHandler.gameObject.name == "PhotonMono"
                    )
                    {
